...
#  if ( NUC_TABLE_MODE == NUC_TABLE_MODE_TEMP )
   Idx_Temp_IG = AddField( "Temp_IG", NORMALIZE_NO, INTERP_FRAC_NO, NORMALIZE_NO, INTERP_FRAC_NO  );
   if ( Idx_Temp_IG != TEMP_IG )    Aux_Error( ERROR_INFO, "inconsistent Idx_Temp_IG (%d != %d) !!\n", Idx_Temp_IG, TEMP_IG );
#  endif

   Idx_dEdt_Nu = AddField( "dEdt_Nu", NORMALIZE_NO, INTERP_FRAC_NO, NORMALIZE_NO, INTERP_FRAC_NO  );
   if ( Idx_dEdt_Nu != DEDT_NU )    Aux_Error( ERROR_INFO, "inconsistent Idx_dEdt_Nu (%d != %d) !!\n", Idx_dEdt_Nu, DEDT_NU );

   Idx_Ye      = AddField( "Ye",      NORMALIZE_NO, INTERP_FRAC_YES, NORMALIZE_NO, INTERP_FRAC_NO );
