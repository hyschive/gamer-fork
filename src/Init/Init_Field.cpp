...
#  if ( NUC_TABLE_MODE == NUC_TABLE_MODE_TEMP )
   Idx_Temp_IG  = AddField( "Temp_IG",  FIXUP_FLUX_YES, FIXUP_REST_YES, NORMALIZE_NO, INTERP_FRAC_NO  );
...
#  if ( NEUTRINO_SCHEME == LEAKAGE )
   Idx_dYedt_Nu = AddField( "dYedt_Nu", FIXUP_FLUX_NO,  FIXUP_REST_NO,  NORMALIZE_NO, INTERP_FRAC_NO  );
