...
static FieldIdx_t ColorField3Idx = Idx_Undefined;
       ...
       double Bondi_SinkMass1;       // total mass             in the void region removed in one global time-step
       double Bondi_SinkMomX1;       // total x-momentum       ...
       double Bondi_SinkMomY1;       // total y-momentum       ...
       double Bondi_SinkMomZ1;       // total z-momentum       ...
       double Bondi_SinkMomXAbs1;    // total |x-momentum|     ...
       double Bondi_SinkMomYAbs1;    // total |y-momentum|     ...
       double Bondi_SinkMomZAbs1;    // total |z-momentum|     ...
       double Bondi_SinkEk1;         // total kinematic energy ...
       double Bondi_SinkEt1;         // total thermal   energy ...
       int    Bondi_SinkNCell1;      // total number of finest cells within the void region
       double Bondi_SinkMass2;       // total mass             in the void region removed in one global time-step
       double Bondi_SinkMomX2;       // total x-momentum       ...
       double Bondi_SinkMomY2;       // total y-momentum       ...
       double Bondi_SinkMomZ2;       // total z-momentum       ...
       double Bondi_SinkMomXAbs2;    // total |x-momentum|     ...
       double Bondi_SinkMomYAbs2;    // total |y-momentum|     ...
       double Bondi_SinkMomZAbs2;    // total |z-momentum|     ...
       double Bondi_SinkEk2;         // total kinematic energy ...
       double Bondi_SinkEt2;         // total thermal   energy ...
       int    Bondi_SinkNCell2;      // total number of finest cells within the void region
