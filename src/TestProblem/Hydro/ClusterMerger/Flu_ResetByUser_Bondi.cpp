...
#  endif   
   const double dt = dTime_AllLv[lv];  // the time-step

// repeat this Flu_ResetByUser_API_Bondi function for every clusters
...
//    update BH mass
      ...
      Bondi_MassBH[c] += SinkMass_OneSubStep_AllRank;
